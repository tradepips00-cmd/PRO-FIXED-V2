...
class ProApp(tk.Tk):
    def __init__(self):
        ...
        tk.Tk.title(self, f"{APP_NAME} {APP_VERSION}")
    ...
    def show_home(self):
        self.clear()
        self.page_title("HOME DASHBOARD", "Professionele GameLoop/TGB optimizer met Magic Start hoofdknop.")
